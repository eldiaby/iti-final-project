...
const serviceLists = [
  ...
  { id: 3, title: "Online Ordering", des: "Explore menu & order with ease using our Cart ", img: "/images/home/services/icon3.png" },
  { id: 4, title: "Gift Cards", des: "Give the gift of exceptional dining with ApoALam  Gift Cards", img: "/images/home/services/icon4.png" },
]
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            <p className="subtitle">Our Features & Services</p>
